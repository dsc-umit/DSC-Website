...
const Testimonials = ({ mode }) => {
    return (
        ...
        <div id="tests" data-theme={mode ? "dark" : "light"}>
            <br /> <br />
            <h2 className="testimonials-h" style={{ textAlign: "center" }}>Testimonials</h2>
            <div class="container" style={{ disply: "block" }}>
                <Col lg={12}>
                    <div class="card w-100 card-view" style={{ marginLeft: "0px", marginTop: "-5px" }} >

                        <div class="card-header " style={{ textAlign: 'center' }} >
                            <b>Kiran Singh</b>
                        </div>
                        <div class="card-body" >
                            <h5 class="testimonials-title">Former DSC Lead</h5>
                            <p class="testimonials-text">Being the DSC-UMIT lead, I had a wonderful experience! From setting up the club,
                    ...
                    <div class="card w-100 card-view" style={{ marginLeft: "0px", marginTop: "-5px" }}>
                        ...
                        <div class="card-body ">
                            <h5 class="testimonials-title">Former Core Member</h5>
                            <p class="testimonials-text">My experience in DSC core team was an amazing one! Not only did I learn how to manage
                    ...
                    <div class="card w-100 card-view" style={{ marginLeft: "0px", marginTop: "-5px" }}>
                        ...
                        <div class="card-body">
                            <h5 class="testimonials-title">Former Core Member</h5>
                            <p class="testimonials-text">My experience with DSC has been quite vivid, I was exposed to various communities where I
